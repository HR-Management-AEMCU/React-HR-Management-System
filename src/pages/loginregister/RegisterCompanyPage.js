...
const Loginpage = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const taxNumber = data.get("taxnumber");
  ...
  if (companyName.trim() === "") {
    toast.error("Şirket adı boş olamaz.", { autoClose: 2000 });
    return;
  }
  if (companyName.length > 20) {
    toast.error("Şirket İsmi maksimum 20 karakter olmalıdır.", { autoClose: 2000 });
    return;
  }

  if (taxNumber.trim() === "") {
    toast.error("Vergi numarası boş olamaz.", { autoClose: 2000 });
    return;
  }

  
    fetch("http://localhost:8090/api/v1/auth/register-manager", {
      method: "POST",
      headers: {
...
<div className="abc">
	...
	<div class="screencompany">
		<div class="screen__content">
			<form class="logincompany" onSubmit={handleSubmit} noValidate>
      ...
      <div class="login__field">
        ...
        <div class="login__field">
					<i class="login__icon fas fa-user"></i>
					<input type="text" class="login__input" placeholder="Company Name" required
                    fullWidth
                    id="companyname"
                    label="companyname"
                    name="companyname"
        ...
        <div class="login__field">
					<i class="login__icon fas fa-user"></i>
					<input type="text" class="login__input" placeholder="Tax Number" required
                    fullWidth
                    id="taxnumber"
                    label="taxnumber"
                    name="taxnumber"
		...
		<div class="screen__background">
			...
			<span class="screen__background__shape screen__background__shape1company"></span>
		</div>		
	</div>
